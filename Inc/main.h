...
#define BLESSYOU_LimitRL_Pin GPIO_PIN_14
#define BLESSYOU_LimitRL_GPIO_Port GPIOB
#define BLESSYOU_LimitLH_Pin GPIO_PIN_15
#define BLESSYOU_LimitLH_GPIO_Port GPIOB
#define BLESSYOU_LimitRLC6_Pin GPIO_PIN_6
#define BLESSYOU_LimitRLC6_GPIO_Port GPIOC
...
#define ACHOO_LimitRL_GPIO_Port GPIOC
#define ACHOO_LimitLH_Pin GPIO_PIN_8
#define ACHOO_LimitLH_GPIO_Port GPIOA
#define ACHOO_LimitRLA9_Pin GPIO_PIN_9
#define ACHOO_LimitRLA9_GPIO_Port GPIOA
